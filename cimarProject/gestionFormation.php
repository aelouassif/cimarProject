					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<form  action="saveFormation.php" method="get">
									<table class="table table-striped table-bordered table-hover" id="datatable_ajax">
										<thead>
											...
											<tr role="row" class="filter">
												...
												<td>
													<input id="matricule" type="text" class="form-control form-filter input-sm" name="theme">
												</td>
												<td>
													<input type="text" class="form-control form-filter input-sm" name="population">
												</td>
												<td>
													<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy/mm/dd">
														<input type="text" class="form-control form-filter input-sm" readonly name="dateDebut" placeholder="yyyy/mm/dd">
														<span class="input-group-btn">
															<button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
														</span>
													</div>
													<div class="input-group date date-picker" data-date-format="yyyy/mm/dd">
														<input type="text" class="form-control form-filter input-sm" readonly name="dateFin" placeholder="yyyy/mm/dd">
														<span class="input-group-btn">
															<button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
														</span>
													</div>
												...
												<td>
													<input type="text" class="form-control form-filter input-sm" name="objectif" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-filter input-sm" name="formateur" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-filter input-sm" name="organisme" placeholder=""/>
												</td>
												<td>
													<select name="personnes[]" class="form-control form-filter input-sm" multiple="true">
														<?php
															...
															foreach ($personnes as $personne) {
																echo "<option value=".$personne->getId().">".$personne->getNomPrenom()."</option>";
															}
														 ?>
 													</select>
...
<script src="assets/admin/pages/scripts/table-ajax-formation.js"></script>
