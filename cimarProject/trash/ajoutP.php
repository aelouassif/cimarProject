					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<form  action="saveP.php" method="get">
									...
									<tr role="row" class="filter">
										<td>
											<input type="text" class="form-control form-filter input-sm" name="matricule">
										</td>
										<td>
										...
										<td>
											<div class="input-group date date-picker margin-bottom-5" data-date-format="dd/mm/yyyy">
												<input type="text" class="form-control form-filter input-sm" readonly name="dateEmbache" placeholder="dd/mm/yyyy">
										...
										<td>
											<div class="input-group date date-picker margin-bottom-5" data-date-format="dd/mm/yyyy">
												<input type="text" class="form-control form-filter input-sm" readonly name="dateNaissance" placeholder="dd/mm/yyyy">
												<span class="input-group-btn">
												<button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
										...
										<td>
											<select name="departement" class="form-control form-filter input-sm">
												<option value="">Select...</option>
